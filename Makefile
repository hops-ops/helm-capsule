...
PACKAGE ?= helm-capsule
XRD_DIR := apis/capsule
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/capsule/standard.yaml
...
EXAMPLES := \
    examples/capsule/minimal.yaml:: \
    examples/capsule/standard.yaml::
